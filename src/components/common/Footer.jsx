      ...
      <div className="container mx-auto px-4">
        <div className="flex flex-wrap justify-between gap-6">
          ...
          <div className="w-full md:w-1/3 lg:w-1/4 mb-6">
            ...
            <p>If you have any questions, feel free to <a href="mailto:info@skillquest.com" className="text-coral-300 hover:underline">email us</a>.</p>
          </div>
        </div>
        <div className="text-center mt-8 border-t border-white pt-4">
          <p className="text-sm">&copy; {new Date().getFullYear()} SkillQuest. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
