...
// // const CourseCard = ({ id, title, description, image, tags, techStack, onDelete }) => {
...
// //         {loading ? (
// //           <>
// //             <div className="h-5 bg-gray-200 rounded mb-2 animate-pulse" style={{ width: '80%' }} />
...
//   return (
//     <section className="bg-white p-6 rounded-lg shadow-md mb-6">
//       <h2 className="text-xl font-semibold mb-4"> Admin Course Management System</h2>
//       <h1> View Course: Browse through the list of courses & DELETE SPECIFIC COURSE.</h1>
...
const CourseCard = ({ id, title, description, image, tags, techStack, onDelete, index }) => {
  const navigate = useNavigate();
  const [loading, setLoading] = useState(true);
